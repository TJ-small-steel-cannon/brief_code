...
import './Left_navigation_bar.css'
...
function Leftnav() {
    ...
    const fixedLinks = leftnav.leftnav.map(nav => {
        // 对每个导航项的链接进行处理，保证结尾为 /
        const fixedNav = { ...nav }; // 复制一个新对象，避免修改原有数据
        if (fixedNav.hyperlinks1) fixedNav.hyperlinks1 = fixedNav.hyperlinks1.endsWith('/') ? fixedNav.hyperlinks1 : fixedNav.hyperlinks1 + '/';
        if (fixedNav.hyperlinks2) fixedNav.hyperlinks2 = fixedNav.hyperlinks2.endsWith('/') ? fixedNav.hyperlinks2 : fixedNav.hyperlinks2 + '/';
        if (fixedNav.hyperlinks3) fixedNav.hyperlinks3 = fixedNav.hyperlinks3.endsWith('/') ? fixedNav.hyperlinks3 : fixedNav.hyperlinks3 + '/';
        if (fixedNav.hyperlinks4) fixedNav.hyperlinks4 = fixedNav.hyperlinks4.endsWith('/') ? fixedNav.hyperlinks4 : fixedNav.hyperlinks4 + '/';
        return fixedNav;
    });
    return (
        <>
            <div className='left_navbar' onMouseOver={mouseover} onMouseOut={mouseout}>
            ...
            <div className='Secondary_menu' id='s1' onMouseOver={mouseover} onMouseOut={mouseout}>
